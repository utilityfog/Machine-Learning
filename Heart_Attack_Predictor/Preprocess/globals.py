...
RANDHIE_NUMERIC_VARIABLES = ['coins', 'tookphys', 'year', 'income', 'xage', 'educdec', 'time', 'outpdol', 'drugdol', 'suppdol', 'mentdol', 'inpdol', 'meddol', 'totadm', 'inpmis', 'mentvis', 'mdvis', 'notmdvis', 'num', 'disea', 'physlm', 'ghindx', 'mdeoff', 'pioff', 'lfam', 'lpi', 'idp', 'logc', 'fmde', 'xghindx', 'linc', 'lnum', 'lnmeddol', 'binexp']